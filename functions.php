...
function theme_enqueue_styles() {
    ...
    wp_enqueue_script('intersection-observer-script', get_stylesheet_directory_uri() . '/assets/js/script.js', array(), filemtime(get_stylesheet_directory() . '/assets/js/script.js'), true);
}
